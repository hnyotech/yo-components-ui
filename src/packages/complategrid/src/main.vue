        ...
        <div v-show="!defaultShowHidden" class="my-grid__moresearch">
                ...
                <el-row :gutter="40">
                    <el-col  v-for="item in realData.formLabel" :key="item.name" :span="item.span">
                        <el-form-item :label="item.name + ':'" :prop="item.value">
                            ...
                            <el-date-picker v-if="item.type=='date'" :format="item.format" :value-format="item.format" type="date" placeholder="请选择时间" size="large" v-model="realData.params[item.value]"></el-date-picker>
                            <el-select v-if="item.type =='select'"  :placeholder="'请选择' + item.name" v-model="realData.params[item.value]" clearable>
            ...
            <el-row :gutter="40" type="flex">
                <el-col v-bind:span="24" style="float:right;text-align:right;">
                    <el-button type="primary" icon="el-icon-setting" class="my-query__reset" @click="reset()">重置</el-button>
